...
$qyuk = mysqli_query($koneksi, "SELECT * FROM siswa ".
						"WHERE aktif = 'true'");
$jml_siswa_sudah = mysqli_num_rows($qyuk);


//jml siswa
$qyuk = mysqli_query($koneksi, "SELECT * FROM siswa ".
						"WHERE aktif = 'false'");
$jml_siswa_belum = mysqli_num_rows($qyuk);



//jml jadwal
$qyuk = mysqli_query($koneksi, "SELECT * FROM m_jadwal");
$jml_jadwal = mysqli_num_rows($qyuk);


//jml soal
$qyuk = mysqli_query($koneksi, "SELECT * FROM m_soal");
$jml_soal = mysqli_num_rows($qyuk);
