...
//jika reset ulang tes
	...
	$tablenilai = "siswa_soal_nilai";
	mysqli_query($koneksi, "DELETE FROM $tablenilai ".
					"WHERE siswa_kd = '$swkd' ".
					"AND jadwal_kd = '$jkd'");
	...
	<td width="50"><strong><font color="'.$warnatext.'">ULANG TES</font></strong></td>
	</tr>
	</thead>
	<tbody>';
	...
	if ($count != 0)
		...
		do 
			...
			<a href="'.$filenya.'?s=ulang&jkd='.$jkd.'&swkd='.$i_kd.'&kunci='.$kunci.'" class="btn btn-danger">RESET</a>
			</td>
			</tr>';
			}
